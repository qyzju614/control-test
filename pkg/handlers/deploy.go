...
func MakeDeployHandler(functionNamespace string, factory k8s.FunctionFactory) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		log.Printf("[pkg/handlers/deploy.go MakeDeployHandler] Call Make a Deployment")
		...
		log.Printf("[pkg/handlers/deploy.go MakeDeployHandler] Created a Deployment")
