...
func MakeReplicaReader(defaultNamespace string, lister v1.DeploymentLister) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		//log.Printf("[pkg/handlers/replica_reader.go MakeReplicaReader] start replica reader")
		...
		// kaiyu: uncommented the following line
		//s := time.Now()
		...
		// kaiyu: uncommented the following two lines
		//d := time.Since(s)
